...
class ExtensionNotSupported(CommandLineError):
    ...
    def __str__(self):
        return self.render((
            ...
            'extratextract. Please suggest this filename extension here:\n\n'
            '    https://github.com/deanmalmgren/extratextract/issues\n\n'
...
class ShellError(CommandLineError):
    ...
    def not_installed_message(self):
        return (
            ...
            "extratextract:\n\n"
            "    http://extratextract.readthedocs.org/en/latest/installation.html\n"
        ) % vars(self)
