# -*- coding: utf-8 -*-
#
# extratextract documentation build configuration file, created by
...
latex_documents = [
  ('index', 'extratextract.tex', u'extratextract Documentation',
...
man_pages = [
    ('index', 'extratextract', u'extratextract Documentation',
     [u'Dean Malmgren'], 1)
]
...
texinfo_documents = [
  ('index', 'extratextract', u'extratextract Documentation',
   u'Dean Malmgren', 'extratextract', 'One line description of project.',
   'Miscellaneous'),
]
